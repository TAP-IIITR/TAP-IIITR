...
const CreateJobPosting = () => {
  ...
  return (
    <div className="p-4 md:p-10 w-full bg-white md:bg-[#F5F5F5]">
      <div className="mb-6">
        <h1 className="text-xl md:text-2xl font-bold text-[#14137D]">Post New Job Opening</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="space-y-4 md:bg-white md:p-6 md:rounded-lg md:shadow-sm">
          <h2 className="text-base font-semibold flex items-center gap-2">
            <svg className="w-4 h-4 md:w-5 md:h-5 text-[#14137D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
