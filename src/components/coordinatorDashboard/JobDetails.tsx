...
import { MdCorporateFare, MdCurrencyRupee, MdOutlineWorkOutline, MdEdit } from "react-icons/md";
...
const JobDetails = () => {
  ...
  const jobDetails = {
    ...
    description: "We are seeking an exceptional Software Engineer to join our innovative technology team. This is an extraordinary opportunity to work on cutting-edge projects while learning from industry experts in a dynamic, fast-paced environment.",
    applicationDeadline: "December 15, 2023",
    startDate: "January 15, 2024",
    skills: [
      "React", "Node.js", "TypeScript", "MongoDB", "AWS", "Docker",
      "Kubernetes", "Python", "SQL", "REST APIs", "GraphQL"
    ]
  };
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center bg-white rounded-[12px] p-6 shadow-sm">
        <div className="w-full md:w-auto mb-6 md:mb-0">
          <div className="flex items-center gap-4 mb-2">
            ...
            <p className="text-[20px] font-[600] text-[#161A80]">{jobDetails.company}</p>
          </div>
      ...
      <div className="flex flex-col lg:flex-row gap-[20px]">
        ...
        <div className="w-full lg:w-[75%] flex flex-col gap-[20px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-[12px] p-6 shadow-sm">
              ...
              <p className="text-[16px] font-[500]">{jobDetails.location}</p>
            </div>
            ...
            <div className="bg-white rounded-[12px] p-6 shadow-sm">
              ...
              <p className="text-[16px] font-[500]">{jobDetails.type}</p>
            </div>
            ...
            <div className="bg-white rounded-[12px] p-6 shadow-sm">
              ...
              <p className="text-[16px] font-[500]">{jobDetails.package}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-[12px] p-6 shadow-sm">
            ...
            <div className="prose max-w-none">
              <p className="text-[16px] text-[#3D3D3D] mb-4">{jobDetails.description}</p>
              <div className="mb-4">
                ...
                <ul className="list-disc list-inside space-y-1 text-[#3D3D3D]">
                  ...
                  <li>Collaborate with cross-functional teams on project requirements</li>
                  <li>Write clean, maintainable, and efficient code</li>
                  <li>Participate in code reviews and software architecture discussions</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          {/* Required Skills */}
          <div className="bg-white rounded-[12px] p-6 shadow-sm">
            <h2 className="text-[20px] font-[600] text-[#212121] mb-4">Required Skills</h2>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-[16px] font-[500]">{jobDetails.applicationDeadline}</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-8 h-8 rounded-full bg-[#F5F5F5] flex items-center justify-center mr-4">
                ...
                <div>
                  ...
                  <p className="text-[16px] font-[500]">{jobDetails.startDate}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full lg:w-[25%]">
          <div className="bg-white rounded-[12px] p-6 shadow-sm sticky top-[24px]">
            <h2 className="text-[20px] font-[600] text-[#212121] mb-4">Actions</h2>
