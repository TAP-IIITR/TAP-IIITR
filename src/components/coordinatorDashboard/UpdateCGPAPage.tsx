              ...
              {showSample && (
                <div className="overflow-hidden rounded-lg border border-gray-200">
                  <div className="bg-gray-50 p-3 border-b border-gray-200">
                    <p className="text-sm text-gray-600">Your Excel file must follow this exact format:</p>
                  </div>
              ...
              <div className="mt-4 bg-blue-50 rounded-lg p-4 border-l-4 border-blue-500">
                ...
                <ul className="space-y-2 text-sm text-blue-700">
                  <li className="flex items-start">
                    ...
                    <span>Column headers must be exactly <strong>reg_no</strong> and <strong>cgpa</strong></span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    <span>Registration numbers must follow the format shown in the sample</span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                  ...
                  <li className="flex items-start">
                    <span className="mr-2">•</span>
                    <span>The system will validate all entries before processing</span>
                  </li>
                </ul>
              </div>
            </div>
